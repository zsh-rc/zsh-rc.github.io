...
parent: ✨ Life Lessons
tags: [English]
excerpt: Collection of new English words
---
...
2. <a href="javascript:void(0)" onclick="playVoice('pavement');">Pavement 🔊 人行道</a>
3. <a href="javascript:void(0)" onclick="playVoice('essence');">Essence 🔊 本质</a>
4. <a href="javascript:void(0)" onclick="playVoice('lecture');">Lecture 🔊 讲座</a>
5. <a href="javascript:void(0)" onclick="playVoice('lecture room');">Lecture Room 🔊 课堂</a>
6. <a href="javascript:void(0)" onclick="playVoice('Florida');">Florida 🔊 弗罗里达</a>
7. <a href="javascript:void(0)" onclick="playVoice('Drum');">Drum/Drummer 🔊 敲鼓/鼓手</a>
8. <a href="javascript:void(0)" onclick="playVoice('Motto');">Motto 🔊 座右铭，箴言，口号</a>
9. <a href="javascript:void(0)" onclick="playVoice('Radical');">Radical 🔊 激进的</a>
10. <a href="javascript:void(0)" onclick="playVoice('Frailty');">Frailty 🔊 脆弱</a>
11. <a href="javascript:void(0)" onclick="playVoice('Defy');">Defy 🔊 违抗，抗拒</a>
12. <a href="javascript:void(0)" onclick="playVoice('Unkindness');">Unkindness 🔊 恶意</a>
13. <a href="javascript:void(0)" onclick="playVoice('Swoon');">Swoon 🔊 陶醉，昏厥</a>
14. **Apple CEO: Tim Cook**
    > I don't care who is doing better than me.
    > Because the truth is,
    > I'm not in competetion with anyone else.
    > **The only person I need to be better than**
    > **is the person I was yesterday.**
    > Last year I was different:
    > I've grown, improved, and learned a lot.
...
15. Vegetables:
    ...
    - <a href="javascript:void(0)" onclick="playVoice('Cilantro');">Cilantro 🔊 香菜，芫荽</a>
    - <a href="javascript:void(0)" onclick="playVoice('Coriander');">Coriander 🔊 香菜，芫荽</a>
    - <a href="javascript:void(0)" onclick="playVoice('Lettuce');">Lettuce 🔊 生菜</a>
    - <a href="javascript:void(0)" onclick="playVoice('Spinach');">Spinach 🔊 菠菜</a>
    - <a href="javascript:void(0)" onclick="playVoice('Pea');">Pea 🔊 豌豆</a>
    - <a href="javascript:void(0)" onclick="playVoice('Cucumber');">Cucumber 🔊 黄瓜</a>
    - <a href="javascript:void(0)" onclick="playVoice('Celery');">Celery 🔊 芹菜</a>
    - <a href="javascript:void(0)" onclick="playVoice('Okra');">Okra 🔊 秋葵</a>
    - <a href="javascript:void(0)" onclick="playVoice('Broccoli');">Broccoli 🔊 西兰花</a>
    - <a href="javascript:void(0)" onclick="playVoice('Cabbage');">Cabbage 🔊 卷心菜</a>
    - <a href="javascript:void(0)" onclick="playVoice('Bok Choy');">Bok Choy 🔊 油菜</a>
    - <a href="javascript:void(0)" onclick="playVoice('Chives');">Chives 🔊 韭菜</a>


📅 2025-12-26

1. <a href="javascript:void(0)" onclick="playVoice('Venezuela');">Venezuela 🔊 委内瑞拉</a>
2. <a href="javascript:void(0)" onclick="playVoice('Nigeria');">Nigeria 🔊 尼日利亚</a>
3. <a href="javascript:void(0)" onclick="playVoice('Marijuana');">Marijuana 🔊 大麻</a>
4. <a href="javascript:void(0)" onclick="playVoice('Crunchy');">Crunchy 🔊 酥脆的</a>
5. <a href="javascript:void(0)" onclick="playVoice('Carbs');">Carbs 🔊 碳水化合物</a>
6. <a href="javascript:void(0)" onclick="playVoice('Wardrobe');">Wardrobe 🔊 衣柜</a>
7. <a href="javascript:void(0)" onclick="playVoice('Maldives');">Maldives 🔊 马尔代夫</a>
8. <a href="javascript:void(0)" onclick="playVoice('Reciprocate');">Reciprocate 🔊 回报</a>
9. <a href="javascript:void(0)" onclick="playVoice('Meatloaf');">Meatloaf 🔊 肉饼</a>
10. Soft nature of a person doesn't mean weakness. Remember nothing is softer than water. But its force can break the strongest of rocks.
11. Man: The city is beautiful at night.
    Woman: Yes. I didn't notice it until we walked around.
12. What am I doing?
    - I'm wiping the mirror.
    - I'm washing the dishes.
    - I'm drying the glass.
    - I'm ironing the T-shirt.
    - I'm chaning the light bulb.
    - I'm dressing the child.
    - I'm hanging the laundry.
    - I'm scrubbing the toilet. (<a href="javascript:void(0)" onclick="playVoice('Scrub');">Scrub 🔊 擦洗</a>)
    - I'm making the bed.
    - I'm sharpening the knife.
    - I'm watering the plants.
    - I'm putting the pillow in the case.
    - I'm sweeping the floor.
    - I'm mopping the floor. (<a href="javascript:void(0)" onclick="playVoice('Mop');">Mop 🔊 拖把</a>)
    - I'm vacuumming the floor. (<a href="javascript:void(0)" onclick="playVoice('vacuumm');">vacuumm 🔊 真空/吸尘</a>)
13. <a href="javascript:void(0)" onclick="playVoice('Whoop');">Whoop 🔊 揍</a>
14. <a href="javascript:void(0)" onclick="playVoice('Placement Test');">Placement Test 🔊 分级测试</a>
15. <a href="javascript:void(0)" onclick="playVoice('Installment');">Installment 🔊 分期/分期付款</a>
